document.addEventListener("DOMContentLoaded", function () {
  ...
  const fromDropdownMenu =
    document
      .querySelector("#tabCountryFromContent")
      .closest(".dropdown-menu") ||
    document.querySelector("#tabCountryFromContent").parentElement;
  const fromDropdown = document.getElementById("dropdownFromBtn");
  // Dropdown "Tới"
  const toDropdownMenu =
    document.querySelector("#tabCountryToContent").closest(".dropdown-menu") ||
    document.querySelector("#tabCountryToContent").parentElement;
  ...
  if (passengerSelect && passengerBox) {
    ...
    document.addEventListener("click", function (event) {
      if (
        !passengerSelect.contains(event.target) &&
        !passengerBox.contains(event.target)
      ) {
